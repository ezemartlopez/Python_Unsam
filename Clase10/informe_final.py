...
import sys
from pruebas.camion import Camion
...
def hacer_informe(lista_camion,lista_precios):
    ...
    for lote in lista_camion:
        ...
        diferencia = lista_precios[lista[0]]-lista[2] #multiplico cajones por precio
...
if __name__=='__main__':
    ...
    # para la linea de comandos: '../Data/camion.csv' '../Data/precios.csv' 'html'